...
map.getView().fit([-9614542.787111, 932279.920994, -9097105.429246, 1275530.278785], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de Museos de Costa Rica</h2>';
        return titleElement;
    })(),
